        ...
        <div className="flex flex-col items-start w-full">
          <div className="flex flex-col items-start w-full">
            <MiniText
              ...
              id="ferla_editable_89d6700c-288d-46c6-b463-60aae8b1b830_38"
            />
            <div className="w-full flex items-start justify-between">
              <h6
                className={styles.manage_block__heading}
                id="ferla_editable_89d6700c-288d-46c6-b463-60aae8b1b830_39"
              >
                Redefining Mobile Business Solutions With {""}
                <strong
                  className="text-red"
                  id="ferla_editable_89d6700c-288d-46c6-b463-60aae8b1b830_40"
                >
                  Ferla Bikes
                </strong>
              </h6>
          ...
          <div className="flex">
            <div className={styles.manage_block__list}>
              <Block
                id="ferla_editable_89d6700c-288d-46c6-b463-60aae8b1b830_41"
                icon={faMoneyBill}
              ...
              <Block
                id="ferla_editable_89d6700c-288d-46c6-b463-60aae8b1b830_42"
                icon={faMoneyBill}
                margin="mt-8"
                paragraph="Unlock the potential of mobile commerce with Ferla Bikes' premier range of innovative and eco-friendly commercial bikes and carts. Our specialty lies in enhancing the dynamic event industry with unparalleled solutions."
              />
              <hr className={styles.manage_block__list__separator} />
              <Block
                id="ferla_editable_89d6700c-288d-46c6-b463-60aae8b1b830_43"
                icon={faMoneyBill}
                margin="mt-8"
                paragraph="Unlock the potential of mobile commerce with Ferla Bikes' premier range of innovative and eco-friendly commercial bikes and carts. Our specialty lies in enhancing the dynamic event industry with unparalleled solutions."
              />
            ...
            <Video
              id="ferla_editable_89d6700c-288d-46c6-b463-60aae8b1b830_44"
